function [TrainingTime,TrainingAccuracy] = elm_train(TrainingData, Elm_Type, NumberofHiddenNeurons, ActivationFunction,chaos_parameter)
...
%%%%% UPDATE
    ...
    %%%%    Chaotic maps has been applied
    %%%%    Authors:    Mustafa Ulaþ, Osman Altay
    %%%%    Firat University, Turkey
    %%%%    EMAIL:      mustafaulas@firat.edu.tr, oaltay@firat.edu.tr
    %%%%    DATE:       2020
...
% a=rand(NumberofHiddenNeurons,NumberofInputNeurons)
% b=rand(NumberofHiddenNeurons,NumberofInputNeurons)*2-1
%% CHAOS Entegration
% 
if chaos_parameter>0 && chaos_parameter<=10
    InputWeight=chaos_dist(NumberofHiddenNeurons,NumberofInputNeurons,chaos_parameter)*2-1;
    BiasofHiddenNeurons=chaos_dist(NumberofHiddenNeurons,1,chaos_parameter);
else 
